		...
		const columns = [
			{
				...
				type:'numeric',
				field:'estado',
				render:(rowData)=>rowData.estado==1?<button className="btn btn-success" onClick={()=>this.confirmacionActive(rowData.idAgencia)}><i className="bi bi-check-square"></i></button> : <button className="btn btn-danger" onClick={()=>this.confirmacionDesactive(rowData.idAgencia)}><i className="bi bi-dash-square"></i></button>
			},{
				title:<h4>Editar</h4>,
